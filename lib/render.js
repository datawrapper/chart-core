...
export default function init(
    ...
    const language = chartAttrs.language.substr(0, 2);
    ...
    chart.load(data || '', isPreview ? undefined : chartAttrs.externalData).then(function() {
        ...
        observeFonts(fonts, theme.typography)
            .then(() => renderChart(target, chart, vis))
            .catch(() => renderChart(target, chart, vis));
