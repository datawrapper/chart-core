...
function chartLoaded() {
    ...
    const externalJSON = __dw.params.chartJSON.metadata.data['use-datawrapper-cdn']
        ? `https://static-stg.dwcdn.net/${__dw.params.chartJSON.id}/${__dw.params.chartJSON.id}.metadata.json`
        : __dw.params.chartJSON.metadata.data['external-data'];

    return chart.load(
        __dw.params.data || '',
        __dw.params.preview ? undefined : __dw.params.chartJSON.externalData,
        __dw.params.preview ? undefined : externalJSON
    );
}
