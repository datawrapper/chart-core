...
test('WEEKDAY', t => {
    t.deepEqual(parser.evaluate('WEEKDAY(DATE(2020,5,10))'), 0);
    t.deepEqual(parser.evaluate('WEEKDAY(DATE(2020,5,11))'), 1);
    t.deepEqual(parser.evaluate('WEEKDAY(DATE(2020,5,12))'), 2);
});
