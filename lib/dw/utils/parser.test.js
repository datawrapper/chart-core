...
test('SUM', t => {
    t.deepEqual(parser.evaluate(`SUM(1,2,3,4)`), 10);
    t.deepEqual(parser.evaluate(`SUM([1,2,3,4])`), 10);
    t.deepEqual(parser.evaluate(`SUM([1,2,3,4,"foo"])`), 10);
    t.deepEqual(parser.evaluate(`SUM([1,2,3,4,1/0])`), 10);
    t.deepEqual(parser.evaluate(`SUM([1,2,FALSE,3,4,1/0])`), 10);
});

test('MEAN', t => {
    t.deepEqual(parser.evaluate(`MEAN([1,2,3,4,10])`), 4);
    t.deepEqual(parser.evaluate(`MEAN(1,2,3,4,10)`), 4);
    t.deepEqual(parser.evaluate(`MEAN([1,2,3,4,"foo"])`), 2.5);
    t.deepEqual(parser.evaluate(`MEAN([1,2,3,4,1/0])`), 2.5);
});

test('MEDIAN', t => {
    t.deepEqual(parser.evaluate(`MEDIAN(1,2,3,4,10)`), 3);
    t.deepEqual(parser.evaluate(`MEDIAN([1,2,3,4,10])`), 3);
    t.deepEqual(parser.evaluate(`MEDIAN([1,2,3,4,"foo"])`), 2.5);
    t.deepEqual(parser.evaluate(`MEDIAN([1,2,3,4,1/0])`), 2.5);
});

test('MIN', t => {
    t.deepEqual(parser.evaluate(`MIN([1,2,3,4,10])`), 1);
    t.deepEqual(parser.evaluate(`MIN(2,3,4,10)`), 2);
    t.deepEqual(parser.evaluate(`MIN([1,2,-3,4,"foo"])`), -3);
    t.deepEqual(parser.evaluate(`MIN([1,2,3,4,1/0])`), 1);
});

test('MAX', t => {
    t.deepEqual(parser.evaluate(`MAX([1,2,3,4,10])`), 10);
    t.deepEqual(parser.evaluate(`MAX(-2,3,4,10)`), 10);
    t.deepEqual(parser.evaluate(`MAX([1,2,3,4,"foo"])`), 4);
    t.deepEqual(parser.evaluate(`MAX([1,2,3,4,1/0])`), 4);
});
