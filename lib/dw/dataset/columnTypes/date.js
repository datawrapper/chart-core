    ...
    const type = {
        ...
        formatter: function() {
            ...
            switch (knownFormats[format].precision) {
                ...
                case 'month':
                    return function(d) {
                        return !isDate(d) ? d : Globalize.format(d, 'MMM yy');
                    };
                case 'week':
                    return function(d) {
                        return !isDate(d)
                ...
                case 'day':
                    return function(d, verbose) {
                        return !isDate(d) ? d : Globalize.format(d, verbose ? 'D' : 'd');
                    };
                case 'day-minutes':
                    return function(d) {
                        return !isDate(d)
                ...
                case 'day-seconds':
                    return function(d) {
                        return !isDate(d) ? d : Globalize.format(d, 'T').replace(' ', '&nbsp;');
                    };
            }
        },
