...
const ymd_utc = (y, m = 1, d = 1) => new Date(Date.UTC(y, m - 1, d));
const yr = y => ymd(y);
...
const months2 = range(1, 13).map(m => ymd(cur_year, m));
...
run('date with week and day (YYYY/W/D)', {
    ...
    parsed: [ymd_utc(2011, 7, 27), ymd_utc(2011, 7, 28), ymd_utc(2011, 7, 29), ymd_utc(2011, 7, 30)]
});
