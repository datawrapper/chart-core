...
import { getNonChartHeight } from './utils/getNonChartHeight.mjs';
...
export default function(attributes) {
    ...
    const chart = {
        ...
        render(isIframe, isPreview) {
            ...
            isIframe && postMessage(container, chart, visualization);
            ...
            function postMessage(container, chart) {
                let desiredHeight;
