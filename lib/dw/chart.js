                ...
                .map(function(row, index) {
                    ...
                    _.each(row, function(val, key) {
                        ...
                        if (dataset.column(key).type() === 'number') {
                            context[columnNameToVar[key] + '__sum'] = colAggregates[key].sum;
                            context[columnNameToVar[key] + '__min'] = colAggregates[key].min;
                            context[columnNameToVar[key] + '__max'] = colAggregates[key].max;
                            context[columnNameToVar[key] + '__mean'] = colAggregates[key].mean;
                            context[columnNameToVar[key] + '__median'] = colAggregates[key].median;
                        }
                    });
