...
<<<<<<< HEAD
${blocks.length ? `<div class="${["menu tooltip svelte-1e6yx1z", !props.icon ? "ha-menu" : ""].join(" ").trim()}">${props.icon ? `${props.icon}` : `<div class="${"svelte-1e6yx1z"}"></div>`}</div>

    <div class="${["menu-content tooltip svelte-1e6yx1z",  "hidden" ].join(" ").trim()}">${validate_component(BlocksRegion, "BlocksRegion").$$render($$result, {
=======
...
<<<<<<< HEAD
  if (!__dw$1.params.preview && externalJSON) {
    return new Promise((resolve, reject) => {
