...
// (402:0) {#if get(theme, 'data.template.afterChart')}
...
// (412:16) {#each regions['footer' + orientation] as block, i}
...
// (410:8) {#each ['Left', 'Center', 'Right'] as orientation}
...
// (440:4) {#each regions.afterBody as block}
				...
				async function run() {
					...
					if (blocks.length) {
						await Promise.all(blocks.map(d => {
							return new Promise((resolve, reject) => {
									const p = [
										loadScript(`${origin && d.source.js.indexOf("http") !== 0
										? `${origin}/`
										: ""}${d.source.js}`)
									];

									if (d.source.css) p.push(loadStylesheet({
										src: `${origin && d.source.js.indexOf("http") !== 0
										? `${origin}/`
										: ""}${d.source.css}`,
...
function create_if_block$a(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*blocks*/ 32) visualization_1_changes.blocks = /*blocks*/ ctx[5];
			if (dirty & /*chartAfterBodyHTML*/ 64) visualization_1_changes.chartAfterBodyHTML = /*chartAfterBodyHTML*/ ctx[6];
			if (dirty & /*isPreview*/ 128) visualization_1_changes.isPreview = /*isPreview*/ ctx[7];
			if (dirty & /*basemap*/ 256) visualization_1_changes.basemap = /*basemap*/ ctx[8];
			if (dirty & /*minimap*/ 512) visualization_1_changes.minimap = /*minimap*/ ctx[9];
			if (dirty & /*highlight*/ 1024) visualization_1_changes.highlight = /*highlight*/ ctx[10];
			if (dirty & /*origin*/ 2048) visualization_1_changes.origin = /*origin*/ ctx[11];
			if (dirty & /*fonts*/ 4096) visualization_1_changes.fonts = /*fonts*/ ctx[12];
			if (dirty & /*styleHolder*/ 65536) visualization_1_changes.styleHolder = /*styleHolder*/ ctx[16];
			if (dirty & /*isStylePlain*/ 8192) visualization_1_changes.isStylePlain = /*isStylePlain*/ ctx[13];
			if (dirty & /*isStyleStatic*/ 16384) visualization_1_changes.isStyleStatic = /*isStyleStatic*/ ctx[14];
