...
function create_if_block$5(ctx) {
	let a;
	let t_value = /*__*/ ctx[2](/*getTheData*/ ctx[1].caption) + "";
	let t;
	...
	return {
		c() {
			...
			attr(a, "aria-label", a_aria_label_value = "" + (/*__*/ ctx[2](/*getTheData*/ ctx[1].caption) + ": " + /*purifyHtml*/ ctx[3](/*chart*/ ctx[0].title, "")));
			attr(a, "href", "data");
		},
		m(target, anchor) {
			insert(target, a, anchor);
		...
		p(ctx, dirty) {
			if (dirty & /*getTheData*/ 2 && t_value !== (t_value = /*__*/ ctx[2](/*getTheData*/ ctx[1].caption) + "")) set_data(t, t_value);

			if (dirty & /*getTheData, chart*/ 3 && a_aria_label_value !== (a_aria_label_value = "" + (/*__*/ ctx[2](/*getTheData*/ ctx[1].caption) + ": " + /*purifyHtml*/ ctx[3](/*chart*/ ctx[0].title, "")))) {
...
function create_fragment$8(ctx) {
	let if_block_anchor;
	let if_block = /*getTheData*/ ctx[1].enabled && create_if_block$5(ctx);
...
function instance$8($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*props*/ 16) {
			 $$invalidate(0, { chart, theme } = props, chart, ($$invalidate(5, theme), $$invalidate(4, props)));
		}

		if ($$self.$$.dirty & /*theme*/ 32) {
			// internal props
			 $$invalidate(1, getTheData = get(theme, "data.options.footer.getTheData", { enabled: false }));
		}
	};
...
rx.MMM = { parse: new RegExp('(' + _$1.flatten(_$1.values(MONTHS)).join('|') + ')') };

_$1.each(rx, function(r) {
    r.parse = r.parse.source;
    if (_$1.isRegExp(r.test)) r.test = r.test.source;
    else r.test = r.parse;
});
...
function create_if_block_6(ctx) {
	...
	blocksregion = new BlocksRegion({
			props: {
				...
				blocks: /*regions*/ ctx[4].header,
				id: "header"
			}
		});

	let if_block = !/*isStyleStatic*/ ctx[3] && create_if_block_7(ctx);
	...
	return {
		...
		p(ctx, dirty) {
			const blocksregion_changes = {};
			if (dirty[0] & /*regions*/ 16) blocksregion_changes.blocks = /*regions*/ ctx[4].header;
			blocksregion.$set(blocksregion_changes);
...
function create_if_block_7(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*menu*/ 32) menu_1_changes.props = /*menu*/ ctx[5];
			if (dirty[0] & /*regions*/ 16) menu_1_changes.blocks = /*regions*/ ctx[4].menu;
...
// (387:0) {#if get(theme, 'data.template.afterChart')}
...
function create_if_block_1$6(ctx) {
	...
	blocksregion0 = new BlocksRegion({
			props: {
				...
				blocks: /*regions*/ ctx[4].aboveFooter
			}
		});
	...
	blocksregion1 = new BlocksRegion({
			props: {
				...
				blocks: /*regions*/ ctx[4].belowFooter
			}
		});
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*regions*/ 16) blocksregion0_changes.blocks = /*regions*/ ctx[4].aboveFooter;
			blocksregion0.$set(blocksregion0_changes);

			if (dirty[0] & /*regions*/ 16) {
			...
			if (dirty[0] & /*regions*/ 16) blocksregion1_changes.blocks = /*regions*/ ctx[4].belowFooter;
...
function create_if_block_4(ctx) {
	...
	return {
		c() {
			span = element("span");
			attr(span, "class", span_class_value = "separator separator-before-" + /*block*/ ctx[32].id);
		},
		m(target, anchor) {
			insert(target, span, anchor);
		},
		p(ctx, dirty) {
			if (dirty[0] & /*regions*/ 16 && span_class_value !== (span_class_value = "separator separator-before-" + /*block*/ ctx[32].id)) {
...
// (402:24) {#if block.prepend}
function create_if_block_3(ctx) {
	let span;
	let raw_value = clean(/*block*/ ctx[32].prepend) + "";
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*regions*/ 16 && raw_value !== (raw_value = clean(/*block*/ ctx[32].prepend) + "")) span.innerHTML = raw_value;		},
		d(detaching) {
			if (detaching) detach(span);
		}
	};
...
// (410:24) {#if block.append}
function create_if_block_2$1(ctx) {
	let span;
	let raw_value = clean(/*block*/ ctx[32].append) + "";
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*regions*/ 16 && raw_value !== (raw_value = clean(/*block*/ ctx[32].append) + "")) span.innerHTML = raw_value;		},
		d(detaching) {
			if (detaching) detach(span);
		}
	};
...
// (397:16) {#each regions['footer' + orientation] as block, i}
function create_each_block_2(ctx) {
	...
	let current;
	let if_block0 = /*i*/ ctx[39] && create_if_block_4(ctx);
	let if_block1 = /*block*/ ctx[32].prepend && create_if_block_3(ctx);
	var switch_value = /*block*/ ctx[32].component;

	function switch_props(ctx) {
		return {
			props: { props: /*block*/ ctx[32].props }
		};
	}
	...
	let if_block2 = /*block*/ ctx[32].append && create_if_block_2$1(ctx);
	...
	return {
		c() {
			...
			attr(span1, "class", span1_class_value = "footer-block " + /*block*/ ctx[32].id + "-block");
		},
		m(target, anchor) {
			if (if_block0) if_block0.m(target, anchor);
			insert(target, t0, anchor);
		...
		p(ctx, dirty) {
			if (/*i*/ ctx[39]) if_block0.p(ctx, dirty);

			if (/*block*/ ctx[32].prepend) {
				if (if_block1) {
					if_block1.p(ctx, dirty);
				} else {
			...
			const switch_instance_changes = {};
			if (dirty[0] & /*regions*/ 16) switch_instance_changes.props = /*block*/ ctx[32].props;

			if (switch_value !== (switch_value = /*block*/ ctx[32].component)) {
				if (switch_instance) {
					group_outros();
					const old_component = switch_instance;
			...
			if (!current || dirty[0] & /*regions*/ 16 && span1_class_value !== (span1_class_value = "footer-block " + /*block*/ ctx[32].id + "-block")) {
...
// (395:8) {#each ['Left', 'Center', 'Right'] as orientation}
function create_each_block_1(ctx) {
	let div;
	let t;
	let div_class_value;
	let current;
	let each_value_2 = /*regions*/ ctx[4]["footer" + /*orientation*/ ctx[35]];
	let each_blocks = [];
	...
	return {
		c() {
			...
			t = space();
			attr(div, "class", div_class_value = "footer-" + /*orientation*/ ctx[35].toLowerCase());
		},
		m(target, anchor) {
			insert(target, div, anchor);
		...
		p(ctx, dirty) {
			if (dirty[0] & /*regions*/ 16) {
				each_value_2 = /*regions*/ ctx[4]["footer" + /*orientation*/ ctx[35]];
				let i;
...
// (425:4) {#each regions.afterBody as block}
...
function create_fragment$g(ctx) {
	...
	let current;
	let if_block0 = !/*isStylePlain*/ ctx[2] && create_if_block_6(ctx);
	let if_block1 = show_if && create_if_block_5(ctx);
	let if_block2 = !/*isStylePlain*/ ctx[2] && create_if_block_1$6(ctx);
	let each_value = /*regions*/ ctx[4].afterBody;
	let each_blocks = [];
	...
	let if_block3 = /*chartAfterBodyHTML*/ ctx[1] && create_if_block$9(ctx);
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*regions*/ 16) {
				each_value = /*regions*/ ctx[4].afterBody;
				let i;
...
`));
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty[0] & /*initialized, theme, basemap, minimap, highlight, target, data, chart, visualization, locales, isPreview, isIframe, fonts, styleHolder, blocks, origin, pluginBlocks, render*/ 15728577) {
			 {
				async function run() {
					...
					if (basemap) {
						d3maps_basemap = { [basemap.__id]: basemap };
					}
					...
					$$invalidate(22, initialized = true);
					$$invalidate(23, render = res.render);
					...
					if (blocks.length) {
						await Promise.all(blocks.map(d => {
							return new Promise((resolve, reject) => {
									...
									if (d.source.css) p.push(loadStylesheet(`${origin ? `${origin}/` : ""}${d.source.css}`));
		...
		if ($$self.$$.dirty[0] & /*theme, data, chart*/ 385) {
			 $$invalidate(25, blockProps = {
				__,
				purifyHtml: clean,
				get,
				theme,
		...
		if ($$self.$$.dirty[0] & /*pluginBlocks, theme, blockProps*/ 35651585) {
			 $$invalidate(24, allBlocks = applyThemeBlockConfig([...coreBlocks, ...pluginBlocks], theme, blockProps));
		}

		if ($$self.$$.dirty[0] & /*allBlocks, chart, data, theme, isStyleStatic*/ 16777609) {
			 {
...
}/* lib/ChartWebComponent.wc.svelte generated by Svelte v3.23.2 */
...
function create_if_block$a(ctx) {
	...
	chart_1 = new Chart({
			props: {
				...
				blocks: /*blocks*/ ctx[5],
				chartAfterBodyHTML: /*chartAfterBodyHTML*/ ctx[6],
				isIframe: false,
				isPreview: /*isPreview*/ ctx[7],
				basemap: /*basemap*/ ctx[8],
				minimap: /*minimap*/ ctx[9],
				highlight: /*highlight*/ ctx[10],
				origin: /*origin*/ ctx[11],
				fonts: /*fonts*/ ctx[12],
				styleHolder: /*styleHolder*/ ctx[16],
				isStylePlain: /*isStylePlain*/ ctx[13],
				isStyleStatic: /*isStyleStatic*/ ctx[14]
			}
		});
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*chart*/ 2) chart_1_changes.chart = /*chart*/ ctx[1];
			if (dirty & /*visualization*/ 4) chart_1_changes.visualization = /*visualization*/ ctx[2];
			if (dirty & /*theme*/ 8) chart_1_changes.theme = /*theme*/ ctx[3];
			if (dirty & /*locales*/ 16) chart_1_changes.locales = /*locales*/ ctx[4];
			if (dirty & /*blocks*/ 32) chart_1_changes.blocks = /*blocks*/ ctx[5];
			if (dirty & /*chartAfterBodyHTML*/ 64) chart_1_changes.chartAfterBodyHTML = /*chartAfterBodyHTML*/ ctx[6];
			if (dirty & /*isPreview*/ 128) chart_1_changes.isPreview = /*isPreview*/ ctx[7];
			if (dirty & /*basemap*/ 256) chart_1_changes.basemap = /*basemap*/ ctx[8];
			if (dirty & /*minimap*/ 512) chart_1_changes.minimap = /*minimap*/ ctx[9];
			if (dirty & /*highlight*/ 1024) chart_1_changes.highlight = /*highlight*/ ctx[10];
			if (dirty & /*origin*/ 2048) chart_1_changes.origin = /*origin*/ ctx[11];
			if (dirty & /*fonts*/ 4096) chart_1_changes.fonts = /*fonts*/ ctx[12];
			if (dirty & /*styleHolder*/ 65536) chart_1_changes.styleHolder = /*styleHolder*/ ctx[16];
			if (dirty & /*isStylePlain*/ 8192) chart_1_changes.isStylePlain = /*isStylePlain*/ ctx[13];
			if (dirty & /*isStyleStatic*/ 16384) chart_1_changes.isStyleStatic = /*isStyleStatic*/ ctx[14];
...
function create_fragment$h(ctx) {
	...
	let if_block_anchor;
	let current;
	let if_block = /*stylesLoaded*/ ctx[15] && create_if_block$a(ctx);
	...
	return {
		...
		p(ctx, [dirty]) {
			if (/*stylesLoaded*/ ctx[15]) {
				if (if_block) {
					if_block.p(ctx, dirty);

					if (dirty & /*stylesLoaded*/ 32768) {
						transition_in(if_block, 1);
					}
				} else {
...
function instance$h($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*stylesLoaded, styleHolder, styles*/ 229376) {
...
class ChartWebComponent_wc extends SvelteElement {
	constructor(options) {
		super();
